...
%reduce the dimension  200D
for m = 1 : 200
    eigenvector_200d(:, m) = eigenvector(:, index1(1, m));
end
y_train_200d = (eigenvector_200d)' * train_images;
y_test_200d = (eigenvector_200d)' * test_images;

distance = zeros(10000, 60000);
%calculate the Euclidean distance
for column_test = 1:10000
    subtract_test_200d = repmat(y_test_200d(:, column_test), 1, 60000);
    dis_matrix = y_train_200d - subtract_test_200d;
...
acc_rate_200d_test = (10000 - error) / 10000;
disp('PCA_accuracy_rate_200d_test: ')
disp(acc_rate_200d_test)